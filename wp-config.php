...
define( 'WPCACHEHOME', '/Applications/MAMP/htdocs/id.nhomdichvu.localhost/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
...
define( 'WP_DEBUG_LOG', getenv('APPLICATION_ENV') == 'development' ? true : false );
define( 'WP_DEBUG_DISPLAY', getenv('APPLICATION_ENV') == 'development' ? true : false );

define( 'WP_MEMORY_LIMIT', '128M' );
define( 'WP_MAX_MEMORY_LIMIT', '256M' );
define('AUTOSAVE_INTERVAL', 300 ); // seconds
define('WP_POST_REVISIONS', getenv('APPLICATION_ENV') == 'development' ? false : true );
