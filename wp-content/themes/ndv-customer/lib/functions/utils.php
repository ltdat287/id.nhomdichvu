...
//			),
			'bootstrap' => array(
				'handle' => $prefix . 'bootstrap',
				'src'    => cherry_file_uri( 'assets/vendor/bootstrap/dist/css/bootstrap.min.css' ),
				'version' => $version
			),
			'toast' => array(
				'handle' => $prefix . 'toast',
				'src'    => cherry_file_uri( 'assets/vendor/toastr/toastr.min.css' ),
				'version' => $version
			),
			'font-awesome' => array(
				'handle' => $prefix . 'font-awesome',
				'src'    => cherry_file_uri( 'assets/vendor/font-awesome/css/font-awesome.min.css' ),
				'version' => $version
			),
			'select2' => array(
				'handle' => $prefix . 'select2',
				'src'    => cherry_file_uri( 'assets/vendor/select2/dist/css/select2.min.css' ),
				'version' => $version
			)
		) );
