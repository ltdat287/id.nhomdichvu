...
<?php if ( $social_params['facebook'] ) : ?>

    <div id="fb-root"></div>

    <?php if ( $social_params['facebook_type'] == 'like' || $social_params['facebook_type'] == 'both' ) : ?>
<!--        <div class="ndv-share-social-button ndv-share-facebook">-->
...
<!--        </div>-->
    ...
    <?php if ( $social_params['facebook_type'] == 'share' || $social_params['facebook_type'] == 'both' ) : ?>
        <div class="ndv-share-social-button text-center">
            <a href="javascript:fbShare('<?php echo $social_params['sharing']['url'] ?>')" class="ndv-share-facebook-share">
                <div class="btn btn-primary dln-button"><i class="fa fa-facebook"></i> <span class="fb-image"></span><span class="fb-text"><?php _e( 'Chia sẻ để kích hoạt', NDV_WOO ) ?></span></div>
            </a>
        </div>
    <?php endif; ?>
...
<?php if ( $social_params['twitter'] ) : ?>

    <div class="ndv-share-social-button text-center ndv-share-twitter">
...
<?php if ( $social_params['google'] ) : ?>

    <?php if ( $social_params['google_type'] == 'plusone' || $social_params['google_type'] == 'both' ) : ?>
        <div class="ndv-share-social-button text-center ndv-share-google">
            <div class="g-plusone" data-size="medium" data-annotation="none" data-callback="gpCallback" data-href="<?php echo $social_params['sharing']['url'] ?>"></div>
        </div>
    <?php endif; ?>

    <?php if ( $social_params['google_type'] == 'share' || $social_params['google_type'] == 'both' ) : ?>
        <div class="ndv-share-social-button ndv-share-google-share">
